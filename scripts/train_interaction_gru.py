"""Train an attention-based focal-plus-neighbors trajectory forecaster."""
...
def main() -> None:
    ...
    parser.add_argument("--interaction-features", nargs="?", const=True, default=False, type=_parse_bool)
    parser.add_argument("--train-scenarios", type=int)
    parser.add_argument("--num-workers", type=int, default=0)
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--run-name", default="interaction-gru")
    parser.add_argument("--output", type=Path, default=Path("checkpoints/interaction_gru.pt"))
    ...
    train_loader = DataLoader(
        train_data, batch_size=args.batch_size, shuffle=True, generator=generator, **loader_options
    )
    ...
    print(f"Interaction features: {args.interaction_features}")
